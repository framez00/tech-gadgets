...
public class CustomerTesting {
    public static void main(String[] args) {
        ...
        Customer newCustomer = new Customer("C04", "Tanjiro", "Kamado", "2000-10-26", "tanjiro.kamado@email.com",
                "19283 Elm Street", "Los Angeles", "CA", 91326, "8187469036");
        ...
        newCustomer = new Customer("C05", "Zenitsu", "Agatsuma", "2000-10-26", "zenitsu.agatsuma@email.com",
                "19283 Elm Street", "Los Angeles", "CA", 91326, "8187469036");
        ...
        cntr.updateCustomerDetails("C01", "newemail@email.com", "18111 Nordhoff Street", "Northridge", "CA", 91330,
                "1234567890");
        cntr.getCustomerInformation("C01");
    }
}